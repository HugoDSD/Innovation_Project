...
namespace Back_end_Innovation_Project.Migrations
{
    ...
    [Migration("20260701160711_AddSymmetricalAndQualityRecommendations")]
    partial class AddSymmetricalAndQualityRecommendations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Back_end_Innovation_Project.MODEL.AppUser", b =>
                {
            ...
            modelBuilder.Entity("Back_end_Innovation_Project.MODEL.EvaluationHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<double>("ValueSavedEur")
                        .HasColumnType("double precision");

                    b.Property<string>("VerdictLevel")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<double>("WaterFootprintLiters")
                        .HasColumnType("double precision");
            ...
            modelBuilder.Entity("Back_end_Innovation_Project.MODEL.EvaluationHistory", b =>
                {
                    b.HasOne("Back_end_Innovation_Project.MODEL.AppUser", "User")
                        .WithMany("Histories")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Back_end_Innovation_Project.MODEL.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
